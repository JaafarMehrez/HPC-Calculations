...
mol = pyscf.M(
    ...
    unit = 'angstrom',
    basis = {
            'LI' : parse_gaussian.load('STO-3G.gbs', 'LI')
    },
    charge = 0,
    spin = 1,
    verbose = 9,
...
mf = mol.ROHF().set(conv_tol=1e-10,max_cycle=999,ddm_tol=1e-14,direct_scf_tol=1e-14,chkfile=name+'.chk',init_guess='atom',irrep_nelec={'Ag': 3, 'B3u':0 , 'B2u':0 ,'B1u':0 })
mf.kernel()
