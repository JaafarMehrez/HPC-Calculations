...
mol = pyscf.M(
    ...
    unit = 'angstrom',
    basis = {
            'B' : parse_gaussian.load('3-21G.gbs', 'B')
    },
    charge = 0,
    spin = 1,
    verbose = 9,
...
mf = mol.UHF().set(conv_tol=1e-10,max_cycle=999,direct_scf_tol=1e-15,chkfile=name+'.chk',init_guess='atom',irrep_nelec={'Ag':4,'B3u':1})
